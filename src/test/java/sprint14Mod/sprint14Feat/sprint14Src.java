...
package sprint14Mod.sprint14Feat;
import pom.sprint14NewPage;
import java.io.File;
...
public class sprint14Src extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new sprint14NewPage(driver).name,"balakrishna@opaltechsolutions.com");
        ...
        try
        {
            actions.EnterData(new sprint14NewPage(driver).password,"Opal@1234");
        ...
        try
        {
            actions.Click(new sprint14NewPage(driver).login);
